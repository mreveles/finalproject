...
namespace BuffTeks.Controllers
{
    public class ClientController : Controller
    {
        ...
        public ClientController(BuffTeksDBContext context)
        {
            _context = context;
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ID,CompanyName,CompanyPhone,CompanyEmail,ComapnyLiaison,LiaisonNumber")] Client client)
        {
            if (id != client.ID)
            {
                return NotFound();
